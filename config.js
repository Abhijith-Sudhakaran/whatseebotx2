...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://imgur.com/a/Vb9DAPB Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Telecat Bot;Abhijith Sudhakaran;918137841760;https://i.imgur.com/st4R2dq.jpeg;https://t.me/Telecat_X',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'Telecat Bot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ʜʏᴘᴇʀᴄᴀᴛ;𝙷𝚢𝚙𝚎𝚛𝚌𝚊𝚝 𝙱𝚘𝚝;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
